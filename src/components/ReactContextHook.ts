...
export const WhatIs2Plus2Context = React.createContext<string>('');
...
export const SubmittedDataContext = React.createContext<SubmittedData>({speciesName: '', planetName: '', numberOfBeings: '', whatIs2Plus2: 'Not 4', reasonForSparing: ''})